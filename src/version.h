...
#define MUDA_VERSION_MINOR 10
#define MUDA_VERSION_PATCH 1
...
#define MUDA_PLUGIN_BACK_COMPATIBLE_VERSION_MAJOR 1
#define MUDA_PLUGIN_BACK_COMPATIBLE_VERSION_MINOR 9
#define MUDA_PLUGIN_BACK_COMPATIBLE_VERSION_PATCH 0
...
#define MUDA_BACKWARDS_COMPATIBLE_VERSION                                                                              \
    MudaMakeVersion(MUDA_BACKWARDS_COMPATIBLE_VERSION_MAJOR, MUDA_BACKWARDS_COMPATIBLE_VERSION_MINOR,                  \
