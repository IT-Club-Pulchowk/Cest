...
static const String CompilerKindId[] = {StringExpand("Project"), StringExpand("Solution")};
...
static const String ApplicationKindId[] = {StringExpand("Executable"), StringExpand("StaticLibrary"),
                                           StringExpand("DynamicLibrary")};
...
static const String SubsystemKindId[] = {StringExpand("Console"), StringExpand("Windows")};
...
static const Compiler_Config_Member CompilerConfigMemberTypeInfo[] = {
    {StringExpand("Kind"), Compiler_Config_Member_Enum, offsetof(Compiler_Config, Kind),
     "Type of compilation. Project only build using a single muda file. Solution iterates through subdirectories and "
     "build each muda file found.",
     &CompilerKindInfo},
    ...
    {StringExpand("Flags"), Compiler_Config_Member_String_Array, offsetof(Compiler_Config, Flags),
     "Flags for the compiler. Different compiler may use different flags, so it is recommended to use sections for "
     "using this property."},
    ...
    {StringExpand("IncludeDirectories"), Compiler_Config_Member_String_Array,
     offsetof(Compiler_Config, IncludeDirectories), "List of directories to search for include files."},
    ...
    {StringExpand("LibraryDirectories"), Compiler_Config_Member_String_Array,
     offsetof(Compiler_Config, LibraryDirectories), "List of paths to be searched for additional libraries."},

    {StringExpand("LinkerFlags"), Compiler_Config_Member_String_Array, offsetof(Compiler_Config, LinkerFlags),
     "Flags for the linker. Different linkers may use different flags, so it is recommended to use sections for using "
     "this property."},

    {StringExpand("IgnoredDirectories"), Compiler_Config_Member_String_Array,
     offsetof(Compiler_Config, IgnoredDirectories),
     "The directories to be ignored when build kind of Solution. Ignored when build kind is Project."},

    {StringExpand("ProjectDirectories"), Compiler_Config_Member_String_Array,
     offsetof(Compiler_Config, ProjectDirectories),
...
INLINE_PROCEDURE void WriteCompilerConfig(Compiler_Config *conf, bool comments, Stream_Writer_Proc writer,
                                          void *context)
{
